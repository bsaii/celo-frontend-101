import { useContractSend } from '@/hooks/contract';
...
export const AddProductModal = () => {
  ...
  const productPriceInWei = parseEther(
  ...
  /** function that handles the creation of a product through the marketplace contract */
  ...
  /** function that handles the creation of a product, if a user submits the product form */
